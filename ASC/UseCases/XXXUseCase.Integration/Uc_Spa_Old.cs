...
namespace Asc
{
    ...
    {        
        ...
        public Uc_Spa_Old()
        {
            ...
            MetaFolderPath = @"D:\Meta\DACF_FrTemp\";
            ResultFolderPath = @"D:\Result\";

            // Temp Stations in French  // TODO: Encapsulate
        ...
        public bool IntraRawSpikeAnalyzer()
        {
            try
            {
                foreach (KeyValuePair<string, List<double>> entry in Dic_TG_List)
                {
                    ...
                    Spa._InputDataPath = MetaFolderPath + @"Cfa\" + "RawTemp_" + entry.Key + ".txt";
                    Spa._OutputDataPath = MetaFolderPath + @"Spa\" + "SpaTemp_" + entry.Key + ".csv";
                    ...
                    //Spa.DateTime_Start = DateTime_Start;
                    Spa.RunAnalysis();
                }
                return true;
            }
